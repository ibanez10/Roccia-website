      ...
      <div className="relative flex items-center justify-between">
        ...
        <div className="flex-1 flex items-center gap-6">
          ...
          <div className="md:hidden relative z-50">
            ...
            {totalQuantity > 0 && (
              <span className="absolute -top-1 -right-[6px] bg-red-600 text-white text-xs w-2 h-2 rounded-full flex items-center justify-center"></span>
            )}
          </div>
        ...
        <div className="flex-1 flex items-center justify-end gap-6">
          <div className="hidden md:flex items-center gap-6">
            ...
            {/* Profile */}
            <button onClick={handleProfileClick} className="hover:scale-110 transition">
              <svg className="size-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  ...
                  <div className="space-y-4">
                    {cartItems.map((item) => (
                      <div key={item.slug} className="flex gap-4 items-center border-b pb-2">
                        <img src={item.usage_image} alt={item.name} className="w-16 h-16 object-contain rounded" />
